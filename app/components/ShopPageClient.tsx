...
// =====================================================================================
// AQUÍ ESTÁ LA ÚNICA PARTE QUE FUE CORREGIDA PARA QUE FUNCIONE
// =====================================================================================
...
const TitleWithStyledTM = ({ name }: { name: string }) => {
  if (!name.includes('™️')) return <>{name}</>;
  const parts = name.split('™️');
  return <>{parts[0]}<span className="trademark-symbol">™️</span>{parts[1]}</>;
};
const StarRating = () => (
