    ...
    <div className="checkout-modal-content confirmation-container">
      ...
      <div className="confirmation-main">
        <div className="confirmation-details">
          ...
          <div className="confirmation-contact">
            ...
            <label className="confirm-checkbox" style={{ fontSize: '0.9rem', fontWeight: 'normal' }}>
              <input type="checkbox" />Enviarme novedades y ofertas por correo electrónico
            </label>
          </div>
        ...
        <div className="confirmation-summary">
          ...
          <div className="summary-row"><span>Total</span><span>PYG {orderData.totalPrice.toLocaleString('es-PY')}</span></div>
        </div>
      </div>
    </div>
  </div>
